...
app.get("/oauth2callback", async (req, res) => {
  ...
  try {
    ...
    let redirectUrl = `http://localhost:5173?signInSuccess=true&googleName=${googleName}`;
    if (userId) {
      redirectUrl = `http://localhost:5173/${userId}?signInSuccess=true&googleName=${googleName}`;
    }
